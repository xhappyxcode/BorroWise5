...
import com.example.shayanetan.borrowise.Fragments.AmountDialogFragment;
import com.example.shayanetan.borrowise.Fragments.DeleteDialogFragment;
import com.example.shayanetan.borrowise.Fragments.PaymentErrorDialogFragment;
import com.example.shayanetan.borrowise.Fragments.RatingDialogFragment;
...
import com.example.shayanetan.borrowise.Fragments.ViewTransactionAbstractFragment;
import com.example.shayanetan.borrowise.Fragments.ViewTransactionItemFragment;
import com.example.shayanetan.borrowise.Fragments.ViewTransactionMoneyFragment;
...
import com.example.shayanetan.borrowise.Models.PaymentHistory;
...
public class ViewTransactionActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(transaction != null && !"".equals(transaction.getClassification())){
            Log.v("TRANSACTION ITEM TYPE", String.valueOf(transaction.getClassification().contentEquals(Transaction.ITEM_TYPE)));
...
//            retrieveTransaction(adapter, viewType, filterType);
    ...
    public void updateTransactionNotif(int id, int type, int daysLeft, String time) {
       Transaction updateTransaction = dbHelper.queryTransaction(id);
        updateTransaction.setAlarmTime(time);
        updateTransaction.setDaysLeft(daysLeft);
        dbHelper.updateTransaction(updateTransaction);
    }
