    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, Cursor cursor) {
        ...
        switch (viewHolder.getItemViewType()) {
            case TYPE_ITEM:
                ...
                ((BorrowedItemViewHolder)viewHolder).tv_duedaysleft_val.setText(daysleft);
                */
...
*/                break;
    ...
    public class BorrowedItemViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_account_item, tv_itemname, tv_duedate_val, tv_duedaysleft_val;
//        Button btn_lost, btn_returned;
        ...
        public BorrowedItemViewHolder(View itemView) {
            ...
            tv_duedaysleft_val = (TextView) itemView.findViewById(R.id.tv_daysleftitem_val);
